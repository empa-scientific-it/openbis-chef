...
export function useLogin() {
    ...
    const { item: token, setItem: setToken } = useSessionStorage<string | null>("token", null);
    ...
    return { token, setToken, loggedIn, setLoggedIn, login, service, loginAndThen, logout }
