...
export const useOperations = (init: MetagraphOperations[]) => {
    ...
    return { currentOperation: operationList.elem, operations: operationList.list, operationIndex: operationList.idx , addOperation, removeOperation, nextOperation, previousOperation, updateOperation, clearOperations, setOperation, goToOperation, updateOperationOriginObject}
