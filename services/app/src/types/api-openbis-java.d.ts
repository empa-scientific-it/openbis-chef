 ...
 * @deprecated
 */
export interface FileFormatTypeSortOptions
  extends SortOptions<FileFormatType> {}
...
export interface ExternalDmsSearchCriteria
  extends AbstractObjectSearchCriteria<IExternalDmsId> {}
...
export interface GitCommitHashSearchCriteria
...
export interface ExperimentTypeSortOptions
  extends SortOptions<ExperimentType> {}
...
export interface RoleAssignmentSortOptions
  extends SortOptions<RoleAssignment> {}

export interface WebAppSettingsSortOptions
  extends SortOptions<WebAppSettings> {}
