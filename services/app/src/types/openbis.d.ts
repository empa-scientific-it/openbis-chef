/* tslint:disable */
/* eslint-disable */
// Generated using typescript-generator version 3.2.1263 on 2023-08-30 12:11:39.
...
export interface OpenBIS {
    ...
    getProjects(arg0: IProjectId[], arg1: ProjectFetchOptions): Promise<{ [index: string]: Project }>;

    getPlugins(arg0: IPluginId[], arg1: PluginFetchOptions): Promise<{ [index: string]: Plugin }>;
    ...
    getTags(arg0: ITagId[], arg1: TagFetchOptions): Promise<{ [index: string]: Tag }>;
    ...
    getRights(arg0: IObjectId[], arg1: RightsFetchOptions): Promise<{ [index: string]: Rights }>;

    getSpaces(arg0: ISpaceId[], arg1: SpaceFetchOptions): Promise<{ [index: string]: Space }>;

    getExperiments(arg0: IExperimentId[], arg1: ExperimentFetchOptions): Promise<{ [index: string]: Experiment }>;

    getExperimentTypes(arg0: IEntityTypeId[], arg1: ExperimentTypeFetchOptions): Promise<{ [index: string]: ExperimentType }>;

    getSamples(arg0: ISampleId[], arg1: SampleFetchOptions): Promise<{ [index: string]: Sample }>;

    getSampleTypes(arg0: IEntityTypeId[], arg1: SampleTypeFetchOptions): Promise<{ [index: string]: SampleType }>;

    getDataSets(arg0: IDataSetId[], arg1: DataSetFetchOptions): Promise<{ [index: string]: DataSet }>;

    getDataSetTypes(arg0: IEntityTypeId[], arg1: DataSetTypeFetchOptions): Promise<{ [index: string]: DataSetType }>;

    getMaterials(arg0: IMaterialId[], arg1: MaterialFetchOptions): Promise<{ [index: string]: Material }>;

    getMaterialTypes(arg0: IEntityTypeId[], arg1: MaterialTypeFetchOptions): Promise<{ [index: string]: MaterialType }>;

    getPropertyTypes(arg0: IPropertyTypeId[], arg1: PropertyTypeFetchOptions): Promise<{ [index: string]: PropertyType }>;

    getVocabularies(arg0: IVocabularyId[], arg1: VocabularyFetchOptions): Promise<{ [index: string]: Vocabulary }>;

    getVocabularyTerms(arg0: IVocabularyTermId[], arg1: VocabularyTermFetchOptions): Promise<{ [index: string]: VocabularyTerm }>;

    getAuthorizationGroups(arg0: IAuthorizationGroupId[], arg1: AuthorizationGroupFetchOptions): Promise<{ [index: string]: AuthorizationGroup }>;

    getRoleAssignments(arg0: IRoleAssignmentId[], arg1: RoleAssignmentFetchOptions): Promise<{ [index: string]: RoleAssignment }>;

    getPersons(arg0: IPersonId[], arg1: PersonFetchOptions): Promise<{ [index: string]: Person }>;

    getExternalDataManagementSystems(arg0: IExternalDmsId[], arg1: ExternalDmsFetchOptions): Promise<{ [index: string]: ExternalDms }>;

    getSemanticAnnotations(arg0: ISemanticAnnotationId[], arg1: SemanticAnnotationFetchOptions): Promise<{ [index: string]: SemanticAnnotation }>;

    getOperationExecutions(arg0: IOperationExecutionId[], arg1: OperationExecutionFetchOptions): Promise<{ [index: string]: OperationExecution }>;

    getQueries(arg0: IQueryId[], arg1: QueryFetchOptions): Promise<{ [index: string]: Query }>;

    getQueryDatabases(arg0: IQueryDatabaseId[], arg1: QueryDatabaseFetchOptions): Promise<{ [index: string]: QueryDatabase }>;

    getPersonalAccessTokens(arg0: IPersonalAccessTokenId[], arg1: PersonalAccessTokenFetchOptions): Promise<{ [index: string]: PersonalAccessToken }>;
    ...
    searchExternalDataManagementSystems(arg0: $ch$ethz$sis$openbis$generic$asapi$v3$dto$externaldms$search$ExternalDmsSearchCriteria$, arg1: ExternalDmsFetchOptions): Promise<SearchResult<ExternalDms>>;
    ...
    executeCustomASService(arg0: ICustomASServiceId, arg1: CustomASServiceExecutionOptions): Promise<any>;
    ...
    downloadFiles(arg0: IDataSetFileId[], arg1: DataSetFileDownloadOptions): Promise<$java$io$InputStream$>;
...
export interface CreateAuthorizationGroupsOperation extends CreateObjectsOperation<AuthorizationGroupCreation> {
...
export interface CreateAuthorizationGroupsOperationResult extends CreateObjectsOperationResult<AuthorizationGroupPermId> {
...
export interface AuthorizationGroupDeletionOptions extends AbstractObjectDeletionOptions<AuthorizationGroupDeletionOptions> {
...
export interface DeleteAuthorizationGroupsOperation extends DeleteObjectsOperation<IAuthorizationGroupId, AuthorizationGroupDeletionOptions> {
...
export interface DeleteAuthorizationGroupsOperationResult extends DeleteObjectsWithoutTrashOperationResult {
...
export interface GetAuthorizationGroupsOperation extends GetObjectsOperation<IAuthorizationGroupId, AuthorizationGroupFetchOptions> {
    fetchOptions: AuthorizationGroupFetchOptions;
...
export interface GetAuthorizationGroupsOperationResult extends GetObjectsOperationResult<IAuthorizationGroupId, AuthorizationGroup> {
...
export interface AuthorizationGroupSearchCriteria extends AbstractObjectSearchCriteria<IAuthorizationGroupId> {
...
export interface SearchAuthorizationGroupsOperation extends SearchObjectsOperation<AuthorizationGroupSearchCriteria, AuthorizationGroupFetchOptions> {
...
export interface SearchAuthorizationGroupsOperationResult extends SearchObjectsOperationResult<AuthorizationGroup> {
...
export interface AuthorizationGroupUpdate extends IUpdate, IObjectUpdate<IAuthorizationGroupId> {
...
export interface UpdateAuthorizationGroupsOperation extends UpdateObjectsOperation<AuthorizationGroupUpdate> {
...
export interface UpdateAuthorizationGroupsOperationResult extends UpdateObjectsOperationResult<AuthorizationGroupPermId> {
    objectIds: AuthorizationGroupPermId[];
...
export interface FetchOptionsToStringBuilder extends Serializable {
    ...
    addFetchOption(arg0: string, arg1: FetchOptions<any>): FetchOptionsToStringBuilder;
...
export interface DeletionFetchOptions extends FetchOptions<Deletion>, Serializable {
...
export interface DeletionSearchCriteria extends AbstractObjectSearchCriteria<IDeletionId> {
...
export interface SearchDeletionsOperation extends SearchObjectsOperation<DeletionSearchCriteria, DeletionFetchOptions> {
...
export interface SearchDeletionsOperationResult extends SearchObjectsOperationResult<Deletion> {
...
export interface EntityKindSearchCriteria extends EnumFieldSearchCriteria<EntityKind> {
...
export interface EntityTypeSearchCriteria extends AbstractObjectSearchCriteria<IEntityTypeId> {
...
export interface Event extends Serializable, IRegistrationDateHolder, IRegistratorHolder {
...
export interface EventDescriptionSearchCriteria extends StringFieldSearchCriteria {
...
export interface EventEntityProjectIdSearchCriteria extends StringFieldSearchCriteria {
...
export interface EventEntityProjectSearchCriteria extends StringFieldSearchCriteria {
...
export interface EventEntityRegistrationDateSearchCriteria extends DateFieldSearchCriteria {
...
export interface EventEntityRegistratorSearchCriteria extends StringFieldSearchCriteria {
...
export interface EventEntitySpaceIdSearchCriteria extends StringFieldSearchCriteria {
...
export interface EventEntitySpaceSearchCriteria extends StringFieldSearchCriteria {
...
export interface EventEntityTypeSearchCriteria extends EnumFieldSearchCriteria<EntityType> {
...
export interface EventIdentifierSearchCriteria extends StringFieldSearchCriteria {
...
export interface EventSearchCriteria extends AbstractObjectSearchCriteria<IEventId> {
...
export interface EventTypeSearchCriteria extends EnumFieldSearchCriteria<EventType> {
...
export interface SearchEventsOperation extends SearchObjectsOperation<EventSearchCriteria, EventFetchOptions> {
...
export interface SearchEventsOperationResult extends SearchObjectsOperationResult<Event> {
...
export interface CreateExternalDmsOperation extends CreateObjectsOperation<ExternalDmsCreation> {
...
export interface CreateExternalDmsOperationResult extends CreateObjectsOperationResult<ExternalDmsPermId> {
...
export interface ExternalDmsCreation extends ICreation, IObjectCreation, ICreationIdHolder {
    code: string;
    label: string;
    address: string;
    addressType: ExternalDmsAddressType;
...
export interface DeleteExternalDmsOperation extends DeleteObjectsOperation<IExternalDmsId, ExternalDmsDeletionOptions> {
...
export interface DeleteExternalDmsOperationResult extends DeleteObjectsWithoutTrashOperationResult {
...
export interface ExternalDmsDeletionOptions extends AbstractObjectDeletionOptions<ExternalDmsDeletionOptions> {
...
export interface GetExternalDmsOperation extends GetObjectsOperation<IExternalDmsId, ExternalDmsFetchOptions> {
    fetchOptions: ExternalDmsFetchOptions;
...
export interface GetExternalDmsOperationResult extends GetObjectsOperationResult<IExternalDmsId, ExternalDms> {
    ids: IExternalDmsId[];
    objects: ExternalDms[];
...
export interface ExternalDmsTypeSearchCriteria extends EnumFieldSearchCriteria<ExternalDmsAddressType> {
...
export interface SearchExternalDmsOperation extends SearchObjectsOperation<any, ExternalDmsFetchOptions> {
    criteria: any;
    fetchOptions: ExternalDmsFetchOptions;
    ...
    new (arg0: $ch$ethz$sis$openbis$generic$asapi$v3$dto$externaldms$search$ExternalDmsSearchCriteria$, arg1: ExternalDmsFetchOptions): SearchExternalDmsOperation;
}

export interface SearchExternalDmsOperationResult extends SearchObjectsOperationResult<ExternalDms> {
...
export interface ExternalDmsUpdate extends IUpdate, IObjectUpdate<IExternalDmsId> {
    externalDmsId: IExternalDmsId;
...
export interface UpdateExternalDmsOperation extends UpdateObjectsOperation<ExternalDmsUpdate> {
...
export interface UpdateExternalDmsOperationResult extends UpdateObjectsOperationResult<ExternalDmsPermId> {
    objectIds: ExternalDmsPermId[];
...
export interface GlobalSearchObjectFetchOptions extends FetchOptions<GlobalSearchObject>, Serializable {
    experiment: ExperimentFetchOptions;
    sample: SampleFetchOptions;
...
export interface GlobalSearchObjectSortOptions extends SortOptions<GlobalSearchObject> {
...
export interface GlobalSearchTextCriteria extends AbstractFieldSearchCriteria<AbstractStringValue> {
    fieldValue: AbstractStringValue;
...
export interface SearchGloballyOperation extends SearchObjectsOperation<GlobalSearchCriteria, GlobalSearchObjectFetchOptions> {
...
export interface SearchGloballyOperationResult extends SearchObjectsOperationResult<GlobalSearchObject> {
...
export interface ObjectKindModificationFetchOptions extends FetchOptions<ObjectKindModification>, Serializable {
...
export interface ObjectKindModificationSortOptions extends SortOptions<ObjectKindModification> {
...
export interface ObjectKindModificationSearchCriteria extends AbstractCompositeSearchCriteria {
...
export interface SearchObjectKindModificationsOperation extends SearchObjectsOperation<ObjectKindModificationSearchCriteria, ObjectKindModificationFetchOptions> {
...
export interface SearchObjectKindModificationsOperationResult extends SearchObjectsOperationResult<ObjectKindModification> {
...
export interface PersonalAccessToken extends Serializable, IModificationDateHolder, IModifierHolder, IOwnerHolder, IPermIdHolder, IRegistrationDateHolder, IRegistratorHolder {
...
export interface CreatePersonalAccessTokensOperation extends CreateObjectsOperation<PersonalAccessTokenCreation> {
...
export interface CreatePersonalAccessTokensOperationResult extends CreateObjectsOperationResult<PersonalAccessTokenPermId> {
...
export interface PersonalAccessTokenCreation extends ICreation, IObjectCreation {
    ownerId: IPersonId;
    sessionName: string;
    validFromDate: Date;
    validToDate: Date;
...
export interface DeletePersonalAccessTokensOperation extends DeleteObjectsOperation<IPersonalAccessTokenId, PersonalAccessTokenDeletionOptions> {
...
export interface DeletePersonalAccessTokensOperationResult extends DeleteObjectsWithoutTrashOperationResult {
...
export interface PersonalAccessTokenDeletionOptions extends AbstractObjectDeletionOptions<PersonalAccessTokenDeletionOptions> {
...
export interface PersonalAccessTokenFetchOptions extends FetchOptions<PersonalAccessToken>, Serializable {
    owner: PersonFetchOptions;
    registrator: PersonFetchOptions;
    modifier: PersonFetchOptions;
...
export interface PersonalAccessTokenSortOptions extends SortOptions<PersonalAccessToken> {
...
export interface GetPersonalAccessTokensOperation extends GetObjectsOperation<IPersonalAccessTokenId, PersonalAccessTokenFetchOptions> {
    fetchOptions: PersonalAccessTokenFetchOptions;
...
export interface GetPersonalAccessTokensOperationResult extends GetObjectsOperationResult<IPersonalAccessTokenId, PersonalAccessToken> {
...
export interface PersonalAccessTokenPermId extends ObjectPermId, IPersonalAccessTokenId {
...
export interface PersonalAccessTokenOwnerSearchCriteria extends PersonSearchCriteria {
...
export interface PersonalAccessTokenSearchCriteria extends AbstractObjectSearchCriteria<IPersonalAccessTokenId> {
...
export interface PersonalAccessTokenSessionNameSearchCriteria extends StringFieldSearchCriteria {
...
export interface SearchPersonalAccessTokensOperation extends SearchObjectsOperation<PersonalAccessTokenSearchCriteria, PersonalAccessTokenFetchOptions> {
...
export interface SearchPersonalAccessTokensOperationResult extends SearchObjectsOperationResult<PersonalAccessToken> {
...
export interface PersonalAccessTokenUpdate extends IUpdate, IObjectUpdate<IPersonalAccessTokenId> {
...
export interface UpdatePersonalAccessTokensOperation extends UpdateObjectsOperation<PersonalAccessTokenUpdate> {
...
export interface UpdatePersonalAccessTokensOperationResult extends UpdateObjectsOperationResult<PersonalAccessTokenPermId> {
    objectIds: PersonalAccessTokenPermId[];
...
export interface CreatePluginsOperation extends CreateObjectsOperation<PluginCreation> {
...
export interface CreatePluginsOperationResult extends CreateObjectsOperationResult<PluginPermId> {
...
export interface DeletePluginsOperation extends DeleteObjectsOperation<IPluginId, PluginDeletionOptions> {
...
export interface DeletePluginsOperationResult extends DeleteObjectsWithoutTrashOperationResult {
...
export interface PluginDeletionOptions extends AbstractObjectDeletionOptions<PluginDeletionOptions> {
...
export interface DynamicPropertyPluginEvaluationOptions extends PluginEvaluationOptions {
    objectId: IObjectId;
...
export interface DynamicPropertyPluginEvaluationResult extends PluginEvaluationResult {
    value: string;
...
export interface EntityValidationPluginEvaluationOptions extends PluginEvaluationOptions {
    objectId: IObjectId;
    isNew: boolean;
...
export interface EntityValidationPluginEvaluationResult extends PluginEvaluationResult {
    error: string;
...
export interface GetPluginsOperation extends GetObjectsOperation<IPluginId, PluginFetchOptions> {
    fetchOptions: PluginFetchOptions;
...
export interface GetPluginsOperationResult extends GetObjectsOperationResult<IPluginId, Plugin> {
    ids: IPluginId[];
    objects: Plugin[];
...
export interface PluginKindSearchCriteria extends EnumFieldSearchCriteria<PluginKind> {
...
export interface PluginSearchCriteria extends AbstractObjectSearchCriteria<IPluginId> {
...
export interface PluginTypeSearchCriteria extends EnumFieldSearchCriteria<PluginType> {
...
export interface SearchPluginsOperation extends SearchObjectsOperation<PluginSearchCriteria, PluginFetchOptions> {
...
export interface SearchPluginsOperationResult extends SearchObjectsOperationResult<Plugin> {
...
export interface UpdatePluginsOperation extends UpdateObjectsOperation<PluginUpdate> {
...
export interface UpdatePluginsOperationResult extends UpdateObjectsOperationResult<PluginPermId> {
    objectIds: PluginPermId[];
...
export interface GetRightsOperation extends GetObjectsOperation<IObjectId, RightsFetchOptions> {
...
export interface GetRightsOperationResult extends GetObjectsOperationResult<IObjectId, Rights> {
    ids: IObjectId[];
    objects: Rights[];
...
export interface CreateRoleAssignmentsOperation extends CreateObjectsOperation<RoleAssignmentCreation> {
...
export interface CreateRoleAssignmentsOperationResult extends CreateObjectsOperationResult<RoleAssignmentTechId> {
...
export interface DeleteRoleAssignmentsOperation extends DeleteObjectsOperation<IRoleAssignmentId, RoleAssignmentDeletionOptions> {
...
export interface DeleteRoleAssignmentsOperationResult extends DeleteObjectsWithoutTrashOperationResult {
...
export interface RoleAssignmentDeletionOptions extends AbstractObjectDeletionOptions<RoleAssignmentDeletionOptions> {
...
export interface GetRoleAssignmentsOperation extends GetObjectsOperation<IRoleAssignmentId, RoleAssignmentFetchOptions> {
    fetchOptions: RoleAssignmentFetchOptions;
...
export interface GetRoleAssignmentsOperationResult extends GetObjectsOperationResult<IRoleAssignmentId, RoleAssignment> {
...
export interface RoleAssignmentSearchCriteria extends AbstractObjectSearchCriteria<IRoleAssignmentId> {
...
export interface SearchRoleAssignmentsOperation extends SearchObjectsOperation<RoleAssignmentSearchCriteria, RoleAssignmentFetchOptions> {
...
export interface SearchRoleAssignmentsOperationResult extends SearchObjectsOperationResult<RoleAssignment> {
...
export interface SampleIdDeserializer extends KeyDeserializer {
    ...
    deserializeKey(arg0: string, arg1: $com$fasterxml$jackson$databind$DeserializationContext$): ISampleId;

    deserializeKey(arg0: string, arg1: $com$fasterxml$jackson$databind$DeserializationContext$): any;
...
export interface CreateSemanticAnnotationsOperation extends CreateObjectsOperation<SemanticAnnotationCreation> {
...
export interface CreateSemanticAnnotationsOperationResult extends CreateObjectsOperationResult<SemanticAnnotationPermId> {
...
export interface DeleteSemanticAnnotationsOperation extends DeleteObjectsOperation<ISemanticAnnotationId, SemanticAnnotationDeletionOptions> {
...
export interface DeleteSemanticAnnotationsOperationResult extends DeleteObjectsWithoutTrashOperationResult {
...
export interface SemanticAnnotationDeletionOptions extends AbstractObjectDeletionOptions<SemanticAnnotationDeletionOptions> {
...
export interface GetSemanticAnnotationsOperation extends GetObjectsOperation<ISemanticAnnotationId, SemanticAnnotationFetchOptions> {
    fetchOptions: SemanticAnnotationFetchOptions;
...
export interface GetSemanticAnnotationsOperationResult extends GetObjectsOperationResult<ISemanticAnnotationId, SemanticAnnotation> {
...
export interface DescriptorAccessionIdSearchCriteria extends StringFieldSearchCriteria {
...
export interface DescriptorOntologyIdSearchCriteria extends StringFieldSearchCriteria {
...
export interface DescriptorOntologyVersionSearchCriteria extends StringFieldSearchCriteria {
...
export interface PredicateAccessionIdSearchCriteria extends StringFieldSearchCriteria {
...
export interface PredicateOntologyIdSearchCriteria extends StringFieldSearchCriteria {
...
export interface PredicateOntologyVersionSearchCriteria extends StringFieldSearchCriteria {
...
export interface SearchSemanticAnnotationsOperation extends SearchObjectsOperation<SemanticAnnotationSearchCriteria, SemanticAnnotationFetchOptions> {
...
export interface SearchSemanticAnnotationsOperationResult extends SearchObjectsOperationResult<SemanticAnnotation> {
...
export interface SemanticAnnotationSearchCriteria extends AbstractObjectSearchCriteria<ISemanticAnnotationId> {
...
export interface SemanticAnnotationUpdate extends IUpdate, IObjectUpdate<ISemanticAnnotationId> {
...
export interface UpdateSemanticAnnotationsOperation extends UpdateObjectsOperation<SemanticAnnotationUpdate> {
...
export interface UpdateSemanticAnnotationsOperationResult extends UpdateObjectsOperationResult<SemanticAnnotationPermId> {
    objectIds: SemanticAnnotationPermId[];
...
export interface AggregationService extends INameHolder, ILabelHolder, IPermIdHolder, Serializable {
...
export interface CustomASServiceExecutionOptions extends AbstractExecutionOptionsWithParameters<CustomASServiceExecutionOptions, any> {
...
export interface ProcessingService extends INameHolder, ILabelHolder, IPermIdHolder, Serializable {
...
export interface ReportingService extends INameHolder, ILabelHolder, IPermIdHolder, Serializable {
...
export interface SearchDomainService extends Serializable, INameHolder, ILabelHolder, IPermIdHolder {
...
export interface AbstractExecutionOptionsWithParameters<EO, V> extends Serializable {
...
export interface AggregationServiceExecutionOptions extends AbstractExecutionOptionsWithParameters<AggregationServiceExecutionOptions, any> {
    parameters: { [index: string]: any };
...
export interface ExecuteAggregationServiceOperationResult extends IOperationResult {
    result: TableModel;
...
export interface ExecuteCustomASServiceOperationResult extends IOperationResult {
    result: any;
...
export interface ExecuteProcessingServiceOperationResult extends IOperationResult {
...
export interface ExecuteReportingServiceOperationResult extends IOperationResult {
    result: TableModel;
...
export interface ExecuteSearchDomainServiceOperationResult extends IOperationResult {
...
export interface ProcessingServiceExecutionOptions extends AbstractExecutionOptionsWithParameters<ProcessingServiceExecutionOptions, string>, IDataSetCodesHolder {
    parameters: { [index: string]: string };
...
export interface ReportingServiceExecutionOptions extends Serializable, IDataSetCodesHolder {
...
export interface SearchDomainServiceExecutionOptions extends AbstractExecutionOptionsWithParameters<SearchDomainServiceExecutionOptions, string> {
    parameters: { [index: string]: string };
...
export interface AggregationServiceFetchOptions extends FetchOptions<AggregationService>, Serializable {
...
export interface AggregationServiceSortOptions extends SortOptions<AggregationService> {
...
export interface CustomASServiceFetchOptions extends FetchOptions<CustomASService>, Serializable {
...
export interface CustomASServiceSortOptions extends SortOptions<CustomASService> {
...
export interface ProcessingServiceFetchOptions extends FetchOptions<ProcessingService>, Serializable {
...
export interface ProcessingServiceSortOptions extends SortOptions<ProcessingService> {
...
export interface ReportingServiceFetchOptions extends FetchOptions<ReportingService>, Serializable {
...
export interface ReportingServiceSortOptions extends SortOptions<ReportingService> {
...
export interface SearchDomainServiceFetchOptions extends FetchOptions<SearchDomainService>, Serializable {
...
export interface SearchDomainServiceSortOptions extends SortOptions<SearchDomainService> {
...
export interface AggregationServiceSearchCriteria extends AbstractObjectSearchCriteria<IDssServiceId> {
...
export interface CustomASServiceSearchCriteria extends AbstractObjectSearchCriteria<ICustomASServiceId> {
...
export interface ProcessingServiceSearchCriteria extends AbstractObjectSearchCriteria<IDssServiceId> {
...
export interface ReportingServiceSearchCriteria extends AbstractObjectSearchCriteria<IDssServiceId> {
...
export interface SearchAggregationServicesOperation extends SearchObjectsOperation<AggregationServiceSearchCriteria, AggregationServiceFetchOptions> {
...
export interface SearchAggregationServicesOperationResult extends SearchObjectsOperationResult<AggregationService> {
...
export interface SearchCustomASServicesOperation extends SearchObjectsOperation<CustomASServiceSearchCriteria, CustomASServiceFetchOptions> {
...
export interface SearchCustomASServicesOperationResult extends SearchObjectsOperationResult<CustomASService> {
...
export interface SearchDomainServiceSearchCriteria extends AbstractObjectSearchCriteria<IDssServiceId> {
...
export interface SearchProcessingServicesOperation extends SearchObjectsOperation<ProcessingServiceSearchCriteria, ProcessingServiceFetchOptions> {
...
export interface SearchProcessingServicesOperationResult extends SearchObjectsOperationResult<ProcessingService> {
...
export interface SearchReportingServicesOperation extends SearchObjectsOperation<ReportingServiceSearchCriteria, ReportingServiceFetchOptions> {
...
export interface SearchReportingServicesOperationResult extends SearchObjectsOperationResult<ReportingService> {
...
export interface SearchSearchDomainServicesOperation extends SearchObjectsOperation<SearchDomainServiceSearchCriteria, SearchDomainServiceFetchOptions> {
...
export interface SearchSearchDomainServicesOperationResult extends SearchObjectsOperationResult<SearchDomainService> {
...
export interface SessionInformationPermId extends ObjectPermId, ISessionInformationId {
...
export interface PersonalAccessTokenSessionSearchCriteria extends BooleanFieldSearchCriteria {
...
export interface SearchSessionInformationOperation extends SearchObjectsOperation<SessionInformationSearchCriteria, SessionInformationFetchOptions> {
...
export interface SearchSessionInformationOperationResult extends SearchObjectsOperationResult<SessionInformation> {
...
export interface SessionInformationSearchCriteria extends AbstractObjectSearchCriteria<ISessionInformationId> {
...
export interface CreateTagsOperation extends CreateObjectsOperation<TagCreation> {
...
export interface CreateTagsOperationResult extends CreateObjectsOperationResult<TagPermId> {
    objectIds: TagPermId[];
...
export interface DeleteTagsOperation extends DeleteObjectsOperation<ITagId, TagDeletionOptions> {
...
export interface DeleteTagsOperationResult extends DeleteObjectsWithoutTrashOperationResult {
...
export interface TagDeletionOptions extends AbstractObjectDeletionOptions<TagDeletionOptions> {
...
export interface GetTagsOperation extends GetObjectsOperation<ITagId, TagFetchOptions> {
    fetchOptions: TagFetchOptions;
...
export interface GetTagsOperationResult extends GetObjectsOperationResult<ITagId, Tag> {
    ids: ITagId[];
    objects: Tag[];
...
export interface SearchTagsOperation extends SearchObjectsOperation<TagSearchCriteria, TagFetchOptions> {
...
export interface SearchTagsOperationResult extends SearchObjectsOperationResult<Tag> {
...
export interface TagSearchCriteria extends AbstractObjectSearchCriteria<ITagId> {
...
export interface UpdateTagsOperationResult extends UpdateObjectsOperationResult<TagPermId> {
    objectIds: TagPermId[];
...
export interface WebAppSettingsFetchOptionsAllSettingsHandler extends IFetchPropertyHandler {
...
export interface WebAppSettingsFetchOptionsSettingsHandler extends IFetchPropertyHandler {
...
export interface IDataStoreServerApi extends IRpcService {

    createDataSets(arg0: string, arg1: FullDataSetCreation[]): DataSetPermId[];

    searchFiles(arg0: string, arg1: DataSetFileSearchCriteria, arg2: DataSetFileFetchOptions): SearchResult<DataSetFile>;

    downloadFiles(arg0: string, arg1: IDataSetFileId[], arg2: DataSetFileDownloadOptions): $java$io$InputStream$;

    createFastDownloadSession(arg0: string, arg1: IDataSetFileId[], arg2: FastDownloadSessionOptions): FastDownloadSession;

    createUploadedDataSet(arg0: string, arg1: UploadedDataSetCreation): DataSetPermId;
...
export interface DataSetFileFetchOptions extends FetchOptions<DataSetFile>, Serializable {
...
export interface DataSetFileSearchCriteria extends AbstractCompositeSearchCriteria {
...
export interface FastDownloadResult {
    ...
    pathsById: { [index: string]: Path };
    fileTransferUserSessionId: string;
    downloadSessionId: string;

    getFileTransferUserSessionId(): string;

    getDownloadSessionId(): string;

    getPathsById(): { [index: string]: Path };

    getStatus(): DownloadStatus;

    new (arg0: $ch$ethz$sis$filetransfer$DownloadClientDownload$): FastDownloadResult;
}

export interface FastDownloadUtils {

    renderAsJson(arg0: $com$fasterxml$jackson$core$JsonGenerator$, arg1: $java$lang$Throwable$): void;

    createExceptionFromJson(arg0: $com$fasterxml$jackson$databind$JsonNode$): $java$lang$RuntimeException$;

    new (): FastDownloadUtils;
}

export interface FastDownloader {
    downloadServer: IDownloadServer;

    withLogger(arg0: $ch$ethz$sis$filetransfer$ILogger$): FastDownloader;

    getDownloadServer(): IDownloadServer;

    withListener(arg0: $ch$ethz$sis$filetransfer$IDownloadListener$): FastDownloader;

    withRetryProviderFactory(arg0: $ch$ethz$sis$filetransfer$IRetryProviderFactory$): FastDownloader;

    downloadTo(arg0: $java$io$File$): FastDownloadResult;

    new (arg0: FastDownloadSession): FastDownloader;

    new (arg0: IDownloadServer, arg1: string, arg2: string, arg3: FastDownloadSessionOptions, arg4: IDataSetFileId[]): FastDownloader;
}

export interface RemoteFastDownloadServer extends IDownloadServer {

    queue(arg0: $ch$ethz$sis$filetransfer$DownloadSessionId$, arg1: $ch$ethz$sis$filetransfer$DownloadRange$[]): void;

    download(arg0: $ch$ethz$sis$filetransfer$DownloadSessionId$, arg1: $ch$ethz$sis$filetransfer$DownloadStreamId$, arg2: number): $java$io$InputStream$;

    startDownloadSession(arg0: $ch$ethz$sis$filetransfer$IUserSessionId$, arg1: $ch$ethz$sis$filetransfer$IDownloadItemId$[], arg2: $ch$ethz$sis$filetransfer$DownloadPreferences$): $ch$ethz$sis$filetransfer$DownloadSession$;

    finishDownloadSession(arg0: $ch$ethz$sis$filetransfer$DownloadSessionId$): void;

    new (arg0: string): RemoteFastDownloadServer;

    new (arg0: string, arg1: number): RemoteFastDownloadServer;
}
...
export interface Path extends Comparable<Path>, Iterable<Path>, Watchable {
    ...
    toRealPath(arg0: $java$nio$file$LinkOption$[]): Path;
...
export type EntityType = "ATTACHMENT" | "DATA_SET" | "EXPERIMENT" | "SPACE" | "MATERIAL" | "PROJECT" | "PROPERTY_TYPE" | "SAMPLE" | "VOCABULARY" | "AUTHORIZATION_GROUP" | "TAG";
...
export type GlobalSearchObjectKind = "EXPERIMENT" | "SAMPLE" | "DATA_SET" | "MATERIAL";

export type ObjectKind = "AUTHORIZATION_GROUP" | "SAMPLE" | "EXPERIMENT" | "MATERIAL" | "DATA_SET" | "SAMPLE_TYPE" | "EXPERIMENT_TYPE" | "MATERIAL_TYPE" | "DATASET_TYPE" | "FILE_FORMAT_TYPE" | "PROJECT" | "SPACE" | "PROPERTY_TYPE" | "PROPERTY_TYPE_ASSIGNMENT" | "VOCABULARY" | "VOCABULARY_TERM" | "ROLE_ASSIGNMENT" | "PERSON" | "GRID_CUSTOM_FILTER" | "GRID_CUSTOM_COLUMN" | "SCRIPT" | "DELETION" | "POSTREGISTRATION_QUEUE" | "QUERY" | "METAPROJECT" | "PERSONAL_ACCESS_TOKEN";
...
export type FastDownloadMethod = "START_DOWNLOAD_SESSION_METHOD" | "QUEUE_METHOD" | "DOWNLOAD_METHOD" | "FINISH_DOWNLOAD_SESSION_METHOD";

export type FastDownloadParameter = "METHOD_PARAMETER" | "RANGES_PARAMETER" | "DOWNLOAD_ITEM_IDS_PARAMETER" | "NUMBER_OF_CHUNKS_PARAMETER" | "WISHED_NUMBER_OF_STREAMS_PARAMETER" | "DOWNLOAD_STREAM_ID_PARAMETER" | "DOWNLOAD_SESSION_ID_PARAMETER" | "USER_SESSION_ID_PARAMETER";

export type DownloadStatus = "NEW" | "STARTED" | "FINISHED" | "FAILED";
